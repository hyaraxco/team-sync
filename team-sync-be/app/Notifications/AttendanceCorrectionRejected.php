...
class AttendanceCorrectionRejected extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ...
            ->line('Pengajuan koreksi absen kamu untuk tanggal '.$date.' telah ditolak.')
            ->line('Catatan: '.$this->correction->review_notes)
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'body' => 'Your attendance correction request has been rejected.',
