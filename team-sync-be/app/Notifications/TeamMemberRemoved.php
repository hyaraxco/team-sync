...
class TeamMemberRemoved extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject('Anggota Tim Dihapus')
            ->greeting('Halo '.$notifiable->name.',')
            ->line($this->memberName.' dihapus dari tim '.$this->teamName.'.')
            ...
            ->line('Silakan cek komposisi tim terbaru.');
    }
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'body' => sprintf('%s was removed from %s.', $this->memberName, $this->teamName),
