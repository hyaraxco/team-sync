    ...
    public function test_benchmark_topsis_ranks_candidates_correctly(): void
    {
        ...
        $candidates = [
            [
                ...
                'avg_manager_rating' => 5.0,
                'final_rating' => 5.0,
                'avg_goal_completion' => 100.0,
                'goal_completion_ratio' => 1.0,
                'positive_feedback_count' => 10,
                'attendance_quality' => 98.0,
                'task_completion_quality' => 97.0,
            ],
            [
                ...
                'final_rating' => 3.0,
                'avg_goal_completion' => 50.0,
                'goal_completion_ratio' => 0.5,
                'positive_feedback_count' => 3,
                'attendance_quality' => 80.0,
                'task_completion_quality' => 78.0,
            ],
            [
                'staff_member_id' => 'emp-3',
                'employee_name' => 'Low Performer',
                'department' => 'Engineering',
                'avg_manager_rating' => 1.0,
                'final_rating' => 1.0,
                'avg_goal_completion' => 10.0,
                'goal_completion_ratio' => 0.1,
                'positive_feedback_count' => 0,
                'attendance_quality' => 60.0,
                'task_completion_quality' => 55.0,
            ],
        ];
