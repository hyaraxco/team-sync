...
Route::prefix('v1')
    ->group(function () {
        ...
        // Setup Wizard (public — no auth required for first-boot)
        Route::get('setup/status', [SetupController::class, 'status']);
        Route::get('setup/doctor', [SetupController::class, 'doctor']);
        Route::post('setup/bootstrap', [SetupController::class, 'bootstrap'])->middleware('throttle:5,1');
        ...
        Route::middleware(['auth:sanctum'])->group(function () {
            ...
            Route::get('licenses/current', [LicenseController::class, 'current']);
            ...
            Route::middleware('feature.enabled:leave')->group(function () {
            ...
            // Payroll routes
            Route::middleware('feature.enabled:payroll')->group(function () {
            ...
            // Overtime routes
            Route::middleware('feature.enabled:overtime')->group(function () {
            ...
            Route::middleware('feature.enabled:thr')->group(function () {
            ...
            Route::middleware('feature.enabled:performance')->group(function () {
