...
const fieldErrors = computed<LoginFieldErrors>(() =>
  error.value && typeof error.value === "object"
    ? (error.value as LoginFieldErrors)
    : {},
);

const hasAuthError = computed(() => error.value === "Unauthorized");
const hasGeneralError = computed(() => error.value && error.value !== "Unauthorized" && typeof error.value !== "object");
  ...
  <div class="w-full max-w-md mx-auto animate-fadeIn px-4">
    <div class="text-center mb-8">
      ...
      <p class="mt-2 text-[15px] text-gray-500">
        Sign in to access your Team Sync dashboard
      </p>
    </div>
    ...
    <div class="mt-8 text-center text-sm font-medium text-gray-500">
      ...
      <span
        class="text-gray-900 cursor-pointer hover:underline underline-offset-4 decoration-gray-300"
