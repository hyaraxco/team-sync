            ...
            <form class="space-y-6" @submit.prevent="handleSubmit">
                            ...
                            <div class="flex flex-col sm:flex-row items-center gap-4">
                                <div class="w-24 h-24 sm:w-32 sm:h-32">
                                    ...
                                    <div class="relative w-24 h-24 sm:w-32 sm:h-32">
                                        ...
                                        <div
                                            class="w-24 h-24 sm:w-32 sm:h-32 absolute bg-brand-primary rounded-full"
                                        ></div>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 pb-6">
                    <button
                        type="submit"
                        :disabled="loading"
                        class="btn-primary w-full sm:w-auto rounded-lg hover:brightness-110 focus:ring-2 focus:ring-brand-primary transition-all duration-300 blue-gradient blue-btn-shadow px-6 py-3 flex items-center gap-2"
                    >
