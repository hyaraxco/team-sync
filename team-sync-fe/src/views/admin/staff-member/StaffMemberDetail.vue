...
import { formatRupiah as formatCurrency, capitalize, getJobStatusText } from "@/utils/formatUtils.js";
...
const loadStaffMember = async () => {
    try {
        ...
        toast.error(
            ...
            staffMemberStore.error || error?.response?.data?.message || "Failed to load staff member.",
        );
...
const handleDeleteStaffMember = async () => {
    try {
        ...
        toast.error(
            ...
            staffMemberStore.error || error?.response?.data?.message || "Failed to delete staff member.",
        );
    }
};
    ...
    <div v-else-if="staffMember">
                ...
                <div class="flex-1">
                    ...
                    <div class="flex items-center gap-6 text-base text-gray-600">
                        <div class="flex items-center gap-2">
                            ...
                            <span>{{ capitalize(staffMember.job_information?.work_location) }}</span>
                        </div>
                        <div class="flex items-center gap-2">
                            <User class="w-4 h-4" />
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <span>Joined {{ formatDate(staffMember.job_information?.start_date) }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-brand-dark text-3xl font-extrabold leading-tight my-2">
                            ...
                            <AnimatedValue v-else :value="performanceStatistics.tasks_completed" />
                        </p>
            ...
            >
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-brand-dark text-3xl font-extrabold leading-tight my-2">
                            <template v-if="loading">...</template>
                            <AnimatedValue v-else :value="performanceStatistics.attendance_rate" suffix="%" />
                        </p>
            ...
            >
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-brand-dark text-3xl font-extrabold leading-tight my-2">
                            <template v-if="loading">...</template>
                            <AnimatedValue v-else :value="performanceStatistics.projects_count" />
                        </p>
            ...
            >
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-brand-dark text-3xl font-extrabold leading-tight my-2">
                            <template v-if="loading">...</template>
                            <AnimatedValue v-else :value="performanceStatistics.performance_score" suffix="%" />
                        </p>
                        <p
                            :class="
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            ...
            <div class="bg-white border border-[#DCDEDD] rounded-[16px] p-6">
                ...
                <div
                    class="space-y-4"
                    v-if="staffMember.emergency_contacts && staffMember.emergency_contacts.length > 0"
                >
                    <div class="flex justify-between items-center">
