...
const createCycle = async () => {
    ...
    try {
        ...
        toast.success("Review cycle created", `"${formData.value.name}" has been created successfully.`);
        router.push({ name: "admin.performance.cycles" });
    } catch (error) {
...
<template>
    <div class="space-y-6">
        ...
        <Alert v-if="errorMessage" type="danger" title="Unable to create review cycle" :message="errorMessage" />

        <MainCard>
            <form @submit.prevent="createCycle" class="space-y-6">
                <div>
                    <label class="block text-sm font-medium text-brand-dark mb-2">Cycle Name *</label>
                    <input
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-sm font-medium text-brand-dark mb-2">Review Period Start *</label>
                        <input
                    ...
                    <div>
                        <label class="block text-sm font-medium text-brand-dark mb-2">Review Period End *</label>
                        <input
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-brand-dark mb-2">Cycle End Date *</label>
                        <input
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        <label class="block text-sm font-medium text-brand-dark mb-2">Self-Assessment Deadline</label>
                        <input
                    ...
                    <div>
                        <label class="block text-sm font-medium text-brand-dark mb-2">Calibration Deadline</label>
                        <input
                ...
                <div class="p-4 bg-blue-50 border border-blue-100 rounded-lg">
                    ...
                    <p class="text-sm text-blue-800 mb-3">
                        Reviewers will be automatically assigned when you generate reviews for this cycle based on the
                        system rules.
                    </p>
                    <ul class="list-disc pl-5 text-sm text-blue-800 space-y-1">
                        <li>
                            <strong>Staff members</strong>
                            are reviewed by their Team Manager (same team preference).
                        </li>
                        <li>
                            <strong>Managers</strong>
                            are reviewed by HR Admins.
                        </li>
                        <li>
                            If no matching role is found, the reviewer will be left empty and can be manually assigned
                            later.
                        </li>
                    </ul>
                </div>
