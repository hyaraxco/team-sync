...
const filteredFeedback = computed(() => {
    let feedback = givenFeedback.value;
...
<template>
    <div class="space-y-6">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-brand-dark">Feedback Diberikan</h1>
                            ...
                            <div class="flex-1">
                                <div class="flex items-center gap-3 mb-1">
                                    <h3 class="text-lg font-semibold text-brand-dark">
                                        {{ feedback.receiver?.full_name || "Unknown Recipient" }}
                                    </h3>
                                    <StatusBadge :value="feedback.feedback_type" type="status" />
                                    <span
