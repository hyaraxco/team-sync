...
<template>
    <div class="mb-6">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
            <div>
                <h1 class="text-2xl font-bold text-brand-dark">Log Absensi</h1>
                <p class="text-sm text-brand-light mt-1">Lihat riwayat log absensi seluruh organisasi.</p>
            </div>
        </div>
    ...
    <div class="bg-white rounded-2xl theme-card-shadow border border-brand-border overflow-hidden">
        ...
        <div class="md:hidden divide-y divide-[#DCDEDD]">
            ...
            <div v-else-if="paginatedAttendances?.length === 0" class="py-12">
                <EmptyState icon="CalendarDays" title="No records found" message="No records match your filters." />
            </div>
