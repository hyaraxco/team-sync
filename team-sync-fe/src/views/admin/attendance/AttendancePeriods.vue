          ...
          <div v-else class="space-y-3">
            ...
            >
              <div class="flex items-center gap-5">
                ...
                <div>
                  <h3 class="text-lg font-medium text-white group-hover:text-indigo-300 transition-colors">{{ period.month }}</h3>
              ...
              <div class="flex items-center gap-4">
                <span 
                  ...
                  :class="{
                    ...
                    'bg-amber-500/10 border-amber-500/20 text-amber-400': period.status === 'review',
                    'bg-neutral-500/10 border-neutral-500/20 text-neutral-400': period.status === 'locked'
                  }"
                >
                  {{ period.status }}
                </span>
                <svg class="w-5 h-5 text-neutral-600 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7"></path></svg>
              </div>
            </div>
          </div>
        </div>
