...
onMounted(async () => {
  if (hasPayrollStatistics.value) {
    await Promise.all([
      ...
      payrollStore.fetchPayrollAnalytics(6),
    ]);
  }
...
const handleExportReport = async () => {
  try {
    await payrollStore.exportPayrollReport({
      ...
      month:
        exportFilters.value.period_type === "monthly"
          ? exportFilters.value.month
          : undefined,
      year:
        exportFilters.value.period_type === "yearly"
          ? exportFilters.value.year
          : undefined,
    });
    ...
    toast.error(
      ...
      payrollStore.error ||
        "Failed to export payroll report. Please try again.",
    );
  }
};
</script>
            ...
            >
              ...
              <div class="flex items-center justify-between w-full gap-2">
                <div class="flex flex-col items-start">
                  <span class="text-brand-dark text-sm font-medium"
                    >Payroll Settings</span
                  >
                  <span class="text-xs font-normal text-gray-500"
                    >Finance only • Configure payroll rules</span
                  >
                </div>
              </div>
            </RouterLink>
      ...
      >
        <div class="flex items-center justify-between gap-3 mb-4">
          <div>
            <h3 class="text-brand-dark text-lg font-bold">
              Payroll Analytics (Last 6 Periods)
            </h3>
        ...
        <template v-else-if="hasAnalyticsData">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-5">
            <div class="border border-[#DCDEDD] rounded-[16px] p-4" data-testid="payroll-analytics-total-amount">
            ...
            <div class="border border-[#DCDEDD] rounded-[16px] p-4" data-testid="payroll-analytics-deduction-rate">
        ...
        <div
          v-else
          data-testid="payroll-analytics-empty"
        ...
        >
          <div class="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p class="text-brand-light text-sm font-normal">
                Prepare payroll drafts from validated attendance and employee
                data.
              </p>
            </div>
          </div>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="border border-[#DCDEDD] rounded-[16px] p-4">
              ...
              <p class="text-brand-light text-sm">
                Generate payroll drafts and monitor each period until Finance
                finalizes payment.
              </p>
            </div>
            <div class="border border-[#DCDEDD] rounded-[16px] p-4">
              ...
              <p class="text-brand-light text-sm">
                Company-wide payroll statistics stay hidden in this view to keep
                salary reporting with Finance.
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="space-y-3">
            ...
            <div class="border border-[#DCDEDD] rounded-[16px] px-4 py-3">
              ...
              <p class="text-brand-light text-xs mt-1">
                Review payroll periods below and open details when a draft is
                ready.
              </p>
            </div>
          </div>
        ...
        <div class="flex items-center gap-3">
          ...
          >
            ...
            <span class="text-brand-white text-sm font-semibold"
              >Export
              {{
                exportFilters.report_type === "detail" ? "Detail" : "Report"
              }}</span
            >
          </button>
          <button
