                            ...
                            <div class="flex items-start gap-4">
                                <div class="w-64 h-42">
                                    ...
                                    <div class="relative w-64 h-42">
                                        <!-- Default background -->
                                        <div
                                            class="w-64 h-42 absolute bg-gray-50 rounded-2xl border-2 border-dashed border-brand-border"
                                        ></div>

                                        <div
                                            class="w-64 h-42 relative z-10 flex items-center justify-center rounded-2xl overflow-hidden"
                                        >
                                            <img loading="lazy"
                                                :src="form.photo_url"
                                                alt="Project Photo"
                                                class="w-64 h-42 object-cover rounded-2xl"
                                                v-if="form.photo_url"
                                            />
