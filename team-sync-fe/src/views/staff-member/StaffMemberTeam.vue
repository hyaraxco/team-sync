...
import { Users, Building, Calendar, Folder, TrendingUp, User, FileText, Clock, CheckCircle } from "lucide-vue-next";
...
const teamUnavailableMessage = ref("");

const isTeamUnavailable = computed(() => !loadingTeam.value && !team.value && Boolean(teamUnavailableMessage.value));
...
const loadTeam = async () => {
    ...
    try {
        ...
        toast.error(
            "Failed to load team",
            staffMemberStore.error || error?.response?.data?.message || "Failed to load team.",
        );
        team.value = null;
...
const loadMembers = async () => {
    ...
    try {
        ...
        toast.error(
            ...
            staffMemberStore.error || error?.response?.data?.message || "Failed to load team members.",
        );
    } finally {
...
const loadProjects = async () => {
    ...
    try {
        ...
        toast.error(
            ...
            staffMemberStore.error || error?.response?.data?.message || "Failed to load team projects.",
        );
    } finally {
    ...
    <div class="flex-1 flex flex-col overflow-hidden">
        ...
        <main class="main-content flex-1 overflow-auto p-5">
            ...
            >
                ...
                <h2 class="text-brand-dark text-2xl font-bold mb-2">You are not assigned to a team yet</h2>
                <p class="text-gray-600 max-w-2xl mx-auto">
                    {{ teamUnavailableMessage }} Please contact HR or your manager to assign your team first.
                </p>
            </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-brand-dark text-3xl font-extrabold leading-tight my-2">
                                    <AnimatedValue :value="activeMembers" />
                                </p>
                    ...
                    >
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-brand-dark text-3xl font-extrabold leading-tight my-2">
                                    <AnimatedValue :value="projects?.length || 0" />
                                </p>
                    ...
                    >
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-brand-dark text-3xl font-extrabold leading-tight my-2">
                                    <AnimatedValue :value="team?.expected_size || 0" />
                                </p>
                    ...
                    >
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-brand-dark text-xl font-extrabold leading-tight my-2">
                        ...
                        >
                            ...
                            <div class="text-center mb-3">
                                ...
                                <p class="text-brand-light text-base">
                                    {{
                                        ...
                                        member.staff_member?.jobInformation?.job_title ||
                                        "N/A"
                                    }}
                                </p>
                            </div>
                            <div class="space-y-1 mb-3">
                                <div class="flex items-center gap-2 text-sm text-gray-500">
                                    <Calendar class="w-4 h-4" />
                                    <span>
                                        {{ member.joined_at ? `Joined ${formatDateUtil(member.joined_at)}` : "N/A" }}
                                    </span>
                                </div>
                                <div class="flex items-center gap-2 text-sm text-gray-500">
                                    <Clock class="w-4 h-4" />
                                    <span>{{ member.joined_at ? formatDateUtil(member.joined_at) : "N/A" }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-between mb-6">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-brand-light text-sm">Projects assigned to {{ team?.name }}</p>
                            </div>
                        </div>
                        <div class="flex items-center gap-2">
                ...
                >
                    ...
                    <div class="space-y-4">
                        ...
                        <div v-if="team?.responsibilities?.length">
                            <h4 class="text-brand-dark text-base font-semibold mb-2">Responsibilities</h4>
                            <ul class="space-y-2">
                                <li
