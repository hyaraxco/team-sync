...
<template>
    <div :class="embedded ? 'space-y-6' : 'hybrid-schedules-container p-3 sm:p-4 md:p-6 lg:p-8'">
        <div :class="embedded ? 'space-y-6' : 'max-w-6xl mx-auto space-y-6'">
            <header
                v-if="!embedded"
            ...
            <div class="space-y-6">
                ...
                <!-- Loading State -->
                <div v-else-if="loading" class="flex justify-center py-14">
                    <div class="w-8 h-8 border-4 border-brand-border border-t-brand-primary rounded-full animate-spin" />
                </div>
                    ...
                    <div class="space-y-4">
                        ...
                        >
                            <EmptyState
                                ...
                                subtitle="Override requests you submit will appear here."
                            />
                        </div>
                        ...
                        <div v-else class="space-y-3">
                            ...
                            >
                                <div class="flex justify-between items-start mb-2">
                                    ...
                                    <StatusBadge :value="override.status" type="leave-status" />
                                </div>

                                <p
                                    v-if="override.reason"
                                    class="text-xs text-brand-light mt-2 border-t border-gray-100 pt-2"
                                >
        ...
        <div v-if="showOverrideModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
            <div class="w-full max-w-md bg-white rounded-2xl p-6 space-y-4">
                ...
                <form @submit.prevent="submitOverride" class="space-y-4">
                    ...
                    <div>
                        <label for="override-mode" class="block text-sm font-medium text-brand-dark mb-1">
                            Requested Work Mode
                        </label>
                        <select
                            id="override-mode"
