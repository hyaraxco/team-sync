        ...
        <div class="bg-white border border-brand-border rounded-2xl p-6 mb-6">
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p class="text-brand-light text-sm">Update your personal information</p>
                </div>
            </div>
            ...
            <form class="space-y-6" @submit.prevent="handleSubmit">
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                >
                                    ...
                                    <span class="text-brand-dark text-base font-semibold">Upload Photo</span>
                                </button>
                                <p class="text-brand-light text-xs">JPG, PNG up to 2MB • Recommended: 400x400px</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-4">
                    <button
                        type="submit"
                        :disabled="loading"
                        class="btn-primary rounded-lg hover:brightness-110 focus:ring-2 focus:ring-brand-primary transition-all duration-300 blue-gradient blue-btn-shadow px-6 py-3"
                    >
                    ...
                    <span v-if="typeof error === 'string'" class="text-red-600 text-sm">{{ error }}</span>
                </div>
            </form>
        </div>
    </div>
