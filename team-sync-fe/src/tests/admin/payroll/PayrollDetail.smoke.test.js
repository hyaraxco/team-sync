...
describe("PayrollDetail smoke", () => {
    ...
    it("lets finance filter reconciliation issues by severity and type", async () => {
        ...
        await wrapper.get('[data-testid="payroll-reconciliation-filter-severity"]').setValue("warning");
        ...
        await wrapper.get('[data-testid="payroll-reconciliation-filter-type"]').setValue("missing_bank_account");
        ...
        await vi.waitFor(() => {
            ...
            expect(wrapper.find('[data-testid="payroll-reconciliation-filter-empty"]').exists()).toBe(true);
        });
    });
    ...
    it("renders payroll activity timeline entries", async () => {
        ...
        const wrapper = factory();
        await flushView();
        await vi.waitFor(() => expect(wrapper.find('[data-testid="payroll-activity-list"]').exists()).toBe(true));

        expect(wrapper.get('[data-testid="payroll-activity-list"]').text()).toContain("Payroll draft generated");
