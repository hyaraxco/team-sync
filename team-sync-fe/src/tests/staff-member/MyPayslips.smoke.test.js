...
describe("MyPayslips smoke", () => {
    ...
    it("shows empty state when employee has no paid payroll history", async () => {
        ...
        expect(wrapper.get('[data-testid="my-payroll-empty"]').text()).toContain("notified once it is ready");
    });
    ...
    it("lets employee clear an active payroll search", async () => {
        ...
        expect(wrapper.get('[data-testid="my-payroll-clear-search"]').text()).toContain("Clear");
