...
const taskStatusColors = {
  done: '#10b981', in_progress: '#3b82f6', review: '#f59e0b',
  todo: '#94a3b8', rejected: '#ef4444', cancelled: '#6b7280',
}
...
const taskStatusDonutSeries = computed(() =>
  (projects.value?.task_status_distribution || []).map(d => d.count)
)
...
const projectStatusColors = {
  ...
  on_hold: '#94a3b8', draft: '#6b7280', cancelled: '#ef4444',
}
...
const projectStatusDonutSeries = computed(() =>
  (projects.value?.project_status_overview || []).map(d => d.count)
)
...
<template>
  ...
  <div v-if="projectsLoading" class="space-y-6">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <div v-for="i in 7" :key="i" class="h-80 bg-gray-100 rounded-[20px] animate-pulse" />
    </div>
  </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      <div class="lg:col-span-2 bg-white border border-[#DCDEDD] rounded-[20px] p-6">
        ...
        <VueApexCharts
          ...
          :options="taskVelocityOptions" :series="taskVelocitySeries"
        />
      ...
      <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-6">
        ...
        <VueApexCharts
          ...
          :options="taskStatusDonutOptions" :series="taskStatusDonutSeries"
        />
        <div v-else class="flex items-center justify-center h-64 text-gray-400 text-sm">No data</div>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-6">
        ...
        <VueApexCharts
          ...
          type="bar" height="300"
          :options="taskPriorityOptions" :series="taskPrioritySeries"
        />
        <div v-else class="flex items-center justify-center h-64 text-gray-400 text-sm">No data</div>
      </div>
      ...
      <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-6">
        ...
        <div class="flex flex-col items-center justify-center h-64">
          <span
            ...
            :class="overdueCount > 0 ? 'text-red-500' : 'text-brand-dark'"
          >
            {{ overdueCount }}
          </span>
          <span class="text-sm text-gray-400 mt-2">
            of {{ totalActiveTasks }} active tasks
          </span>
          <span
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-6">
        ...
        <VueApexCharts
          ...
          type="donut" height="300"
          :options="projectStatusDonutOptions" :series="projectStatusDonutSeries"
        />
        <div v-else class="flex items-center justify-center h-64 text-gray-400 text-sm">No data</div>
      </div>
      ...
      <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-6">
        ...
        <VueApexCharts
          ...
          type="bar" height="300"
          :options="projectTypeOptions" :series="projectTypeSeries"
        />
        <div v-else class="flex items-center justify-center h-64 text-gray-400 text-sm">No data</div>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 gap-6">
      <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-6">
        ...
        <VueApexCharts
          ...
          type="bar" height="300"
          :options="teamProductivityOptions" :series="teamProductivitySeries"
        />
        <div v-else class="flex items-center justify-center h-64 text-gray-400 text-sm">No data</div>
      </div>
    </div>
  ...
  <div v-else class="flex flex-col items-center justify-center py-20 text-gray-400">
    <FolderKanbanIcon class="w-16 h-16 mb-4 opacity-30" />
