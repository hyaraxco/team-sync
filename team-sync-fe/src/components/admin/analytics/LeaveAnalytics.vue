...
const monthlyLeaveOptions = computed(() => ({
  chart: { type: 'bar', height: 300, stacked: true, toolbar: { show: false }, fontFamily: 'Plus Jakarta Sans, sans-serif' },
...
const typeDonutSeries = computed(() =>
  (leave.value?.type_distribution || []).map(d => d.count)
)
  ...
  plotOptions: {
    radialBar: {
      ...
      dataLabels: {
        ...
        value: { fontSize: '28px', fontWeight: 700, color: '#1e293b', offsetY: 5, formatter: v => `${Math.round(v)}%` },
      },
    },
  },
  colors: ['#10b981'],
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      <div class="lg:col-span-2 bg-white border border-[#DCDEDD] rounded-[20px] p-6">
        ...
        <VueApexCharts
          ...
          type="bar" height="300"
          :options="monthlyLeaveOptions" :series="monthlyLeaveSeries"
        />
      ...
      <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-6">
        ...
        <VueApexCharts
          ...
          :options="typeDonutOptions" :series="typeDonutSeries"
        />
        <div v-else class="flex items-center justify-center h-64 text-gray-400 text-sm">No data</div>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-6">
        ...
        <VueApexCharts
          ...
          :options="approvalRateOptions" :series="approvalRateSeries"
        />
      ...
      <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-6">
        ...
        <VueApexCharts
          ...
          type="bar" height="300"
          :options="avgDurationOptions" :series="avgDurationSeries"
        />
        <div v-else class="flex items-center justify-center h-64 text-gray-400 text-sm">No data</div>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      <div class="lg:col-span-2 bg-white border border-[#DCDEDD] rounded-[20px] p-6">
        ...
        <VueApexCharts
          ...
          type="bar" height="300"
          :options="deptLeaveOptions" :series="deptLeaveSeries"
        />
        <div v-else class="flex items-center justify-center h-64 text-gray-400 text-sm">No data</div>
      </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-6">
        ...
        <VueApexCharts
          ...
          type="radialBar" height="300"
          :options="complianceOptions" :series="complianceSeries"
        />
        <div v-if="leave.proof_compliance" class="flex items-center justify-center gap-6 mt-2">
          ...
          <div class="text-center">
            <p class="text-lg font-semibold text-gray-500">{{ leave.proof_compliance.total_sick_leaves }}</p>
