...
const statusColors = {
  ...
  half_day: '#8b5cf6', sick_leave: '#06b6d4', annual_leave: '#3b82f6',
}
...
const statusDonutSeries = computed(() =>
  (attendance.value?.status_distribution || []).map(d => d.count)
)
...
<template>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      <div class="lg:col-span-2 bg-white border border-[#DCDEDD] rounded-[20px] p-6">
        ...
        <VueApexCharts
          ...
          :options="monthlyRateOptions" :series="monthlyRateSeries"
        />
      ...
      <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-6">
        ...
        <VueApexCharts
          ...
          :options="statusDonutOptions" :series="statusDonutSeries"
        />
        <div v-else class="flex items-center justify-center h-64 text-gray-400 text-sm">No data</div>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-6">
        ...
        <VueApexCharts
          ...
          type="bar" height="300"
          :options="latenessOptions" :series="latenessSeries"
        />
        <div v-else class="flex items-center justify-center h-64 text-gray-400 text-sm">No data</div>
      </div>
      ...
      <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-6">
        ...
        <VueApexCharts
          ...
          :options="avgHoursOptions" :series="avgHoursSeries"
        />
        <div v-else class="flex items-center justify-center h-64 text-gray-400 text-sm">No data</div>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
      <div class="lg:col-span-2 bg-white border border-[#DCDEDD] rounded-[20px] p-6">
        ...
        <VueApexCharts
          ...
          type="bar" height="300"
          :options="workModeOptions" :series="workModeSeries"
        />
        <div v-else class="flex items-center justify-center h-64 text-gray-400 text-sm">No data</div>
      </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
      <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-6">
        ...
        <VueApexCharts
          ...
          type="bar" height="300"
          :options="mismatchOptions" :series="mismatchSeries"
        />
        <div v-else class="flex items-center justify-center h-64 text-gray-400 text-sm">No data</div>
      </div>
      ...
      <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-6">
        ...
        <VueApexCharts
          ...
          type="line" height="300"
          :options="correctionOptions" :series="correctionSeries"
        />
        <div v-else class="flex items-center justify-center h-64 text-gray-400 text-sm">No data</div>
      </div>
    </div>
  ...
  <div v-else class="flex flex-col items-center justify-center py-20 text-gray-400">
    <CalendarCheckIcon class="w-16 h-16 mb-4 opacity-30" />
