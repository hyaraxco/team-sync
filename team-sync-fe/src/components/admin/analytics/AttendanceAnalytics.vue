...
<template>
    ...
    <div v-else-if="attendance" class="space-y-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white border border-brand-border rounded-2xl p-6">
                ...
                <div v-else class="flex items-center justify-center h-48 text-gray-400 text-sm">No late arrival records</div>
            </div>
        </div>
    ...
    <div v-else class="flex flex-col items-center justify-center py-20 text-gray-400">
        ...
        <p class="text-lg font-medium">Attendance analytics not yet available</p>
