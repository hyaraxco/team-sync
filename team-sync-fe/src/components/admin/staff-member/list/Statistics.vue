...
const addedThisMonth = computed(
  () => staffMemberStore.statistics.added_this_month
);
      ...
      <div class="flex flex-col justify-center h-full relative z-10">
        ...
        <div class="flex items-center justify-between mb-4">
          <div>
            ...
            >
              <template v-if="loading">...</template><AnimatedValue v-else :value="total" />
            </p>
      ...
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-brand-dark text-3xl font-extrabold leading-none my-2">
            <template v-if="loading">...</template><AnimatedValue v-else :value="active" />
          </p>
          <p
    ...
    >
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-brand-dark text-3xl font-extrabold leading-none my-2">
            <template v-if="loading">...</template><AnimatedValue v-else :value="newEmployees" />
          </p>
    ...
    >
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-brand-dark text-3xl font-extrabold leading-none my-2">
            <template v-if="loading">...</template><AnimatedValue v-else :value="onLeave" />
          </p>
          <p
