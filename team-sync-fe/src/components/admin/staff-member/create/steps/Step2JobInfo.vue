...
const { employmentTypes, jobStatuses, workLocations } = storeToRefs(optionStore);
            ...
            <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-6">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-brand-light text-sm font-normal">Role, department, and employment details</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                    ...
                    <div class="mb-4">
                        <Select
                            ...
                            :error="errors?.roles?.join(', ') || errors?.['roles.0']?.join(', ')"
                            required
                        >
                            <template #icon>
                    ...
                    <!-- Team -->
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 mb-1.5">Team</label>
                        <div class="relative">
            ...
            <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-brand-light text-xs font-normal mt-1">Enter only numbers (8-20 digits)</p>
                    </div>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-brand-light text-sm font-normal">Choose the team for this employee</p>
                        </div>
                    </div>
                    <button
                        type="button"
