            ...
            <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-6">
                ...
                <div class="flex flex-col items-center">
                    ...
                    <div class="flex flex-col gap-3 items-center">
                        ...
                        <p v-if="photoError || errors?.profile_photo?.length" class="text-red-600 text-xs text-center">
            ...
            <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-6 mb-6">
                <div class="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        ...
                        <p class="text-brand-light text-sm font-normal">Login information and account details</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 xl:grid-cols-2 gap-5">
                    ...
                    <div class="mb-4">
                        <Input
                            ...
                            :label="props.isEditMode ? 'Password (leave blank to keep current)' : 'Password *'"
                    ...
                    <div class="mb-4">
                        <Input
                            ...
                            :label="props.isEditMode ? 'Confirm Password' : 'Confirm Password *'"
                ...
                <div class="grid grid-cols-1 xl:grid-cols-2 gap-5">
                    ...
                    <div class="xl:col-span-2 mb-4">
                        ...
                        <div class="flex flex-col sm:flex-row gap-4">
                            ...
                            >
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 bg-pink-50 rounded-[12px] flex items-center justify-center">
