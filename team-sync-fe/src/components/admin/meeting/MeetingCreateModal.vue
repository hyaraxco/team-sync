      ...
      <div class="grid grid-cols-2 gap-6 pt-2">
          ...
          <div class="space-y-2">
            ...
            >
              <input
                ...
                class="w-4 h-4 text-[#0C51D9] border-gray-300 rounded focus:ring-[#0C51D9]"
              />
        ...
        <div>
          ...
          <div class="space-y-2 max-h-48 overflow-y-auto pr-2 custom-scrollbar">
            ...
            <div v-if="teamStore.teams.length === 0 && !teamStore.loading" class="text-sm text-gray-500 italic">
              No teams available
            </div>
            <div v-if="teamStore.loading" class="text-sm text-gray-500">
              Loading teams...
            </div>
          </div>
        </div>
