    ...
    >
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-brand-dark text-3xl font-extrabold leading-none my-2">
            <template v-if="loading">...</template><AnimatedValue v-else :value="members" />
          </p>
    ...
    >
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-brand-dark text-3xl font-extrabold leading-none my-2">
            <template v-if="loading">...</template><AnimatedValue v-else :value="averageSize" />
          </p>
    ...
    >
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-brand-dark text-3xl font-extrabold leading-none my-2">
            <template v-if="loading">...</template><AnimatedValue v-else :value="newTeams" />
          </p>
