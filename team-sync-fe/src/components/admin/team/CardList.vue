    ...
    >
        ...
        <div class="flex gap-2">
            <RouterLink
                ...
                class="btn-secondary flex-1 text-brand-dark text-sm font-semibold border border-brand-border rounded-lg px-4 py-3 hover:ring-2 hover:ring-brand-primary/20 hover:bg-gray-50 transition-all duration-300 flex items-center justify-center gap-2"
            >
                <Eye class="w-4 h-4" />
                <span>View</span>
            </RouterLink>
