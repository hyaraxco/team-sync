...
<template>
  ...
  <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mb-6">
    ...
    <div class="bg-white border border-[#DCDEDD] rounded-[20px] p-4 sm:p-6">
      ...
      <div
        v-else-if="recentActivitiesError"
        class="rounded-[12px] border border-red-100 bg-red-50 px-3 py-3"
      >
      ...
      <div v-else class="space-y-1">
        ...
        >
          ...
          <div class="flex-1 min-w-0">
            ...
            <p
              v-if="activity.body"
              class="mt-0.5 text-xs text-gray-500 leading-5"
            >
              {{ activity.body }}
            </p>
