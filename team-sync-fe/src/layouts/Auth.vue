<template>
  <div class="auth-shell min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
    ...
    <div class="flex min-h-screen w-full">
      <!-- Left Side - Visual (35%) -->
      <aside
        class="relative hidden overflow-hidden lg:flex lg:w-[35%] xl:w-[40%]"
      >
        ...
        <img
          ...
          fetchpriority="high"
        />
        <div class="absolute inset-0 bg-gradient-to-br from-[#0C51D9]/90 via-[#1a3a6e]/85 to-[#0a1f44]/95"></div>
        
        <!-- Decorative Elements -->
        <div class="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,rgba(255,255,255,0.1),transparent_50%)]"></div>
        <div class="absolute bottom-0 left-0 right-0 h-1/2 bg-gradient-to-t from-black/30 to-transparent"></div>
        ...
        <div class="relative z-10 flex h-full flex-col justify-between p-8 xl:p-12">
          ...
          <!-- Tagline -->
          <div class="space-y-4">
            <p class="inline-flex items-center rounded-full bg-white/15 px-3 py-1.5 text-xs font-medium text-white/90 backdrop-blur-sm">
