...
export const usePerformanceReviewStore = defineStore("performanceReview", {
    ...
    actions: {
        ...
        async updateCycle(id, data) {
            ...
            this.success = false;
            try {
                const response = await axiosInstance.put(`/performance/cycles/${id}`, data);
        ...
        async fetchMyReviews(filters = {}) {
            ...
            this.error = null;
            try {
                const response = await axiosInstance.get("/performance/reviews/my-reviews", { params: filters });
        ...
        async fetchTeamReviews(filters = {}) {
            ...
            this.error = null;
            try {
                const response = await axiosInstance.get("/performance/reviews/team-reviews", { params: filters });
        ...
        async fetchActiveSections() {
            ...
            this.error = null;
            try {
                const response = await axiosInstance.get("/performance/reviews/sections");
        ...
        async submitSelfAssessment(reviewId, responses) {
            ...
            this.success = false;
            try {
                const response = await axiosInstance.post(`/performance/reviews/${reviewId}/self-assessment`, {
                    responses,
                });
                this.currentReview = response.data.data;
                this.success = true;
        ...
        async submitManagerAssessment(reviewId, responses, finalRating) {
            ...
            this.success = false;
            try {
                const response = await axiosInstance.post(`/performance/reviews/${reviewId}/manager-assessment`, {
                    responses,
        ...
        async calibrateReview(reviewId, responses) {
            ...
            this.success = false;
            try {
                const response = await axiosInstance.post(`/performance/reviews/${reviewId}/calibrate`, { responses });
                this.currentReview = response.data.data;
                this.success = true;
                return response.data.data;
            } catch (error) {
        ...
        async fetchPendingCalibration(filters = {}) {
            ...
            this.error = null;
            try {
                const response = await axiosInstance.get("/performance/reviews/pending-calibration", {
                    params: filters,
                });
        ...
        async fetchCalibrationContext(reviewId) {
            ...
            this.error = null;
            try {
                const response = await axiosInstance.get(`/performance/reviews/${reviewId}/calibration-context`);
