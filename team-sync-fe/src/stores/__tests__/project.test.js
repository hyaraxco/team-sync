...
describe("Project Store", () => {
    ...
    it("createProject calls POST multipart and sets success", async () => {
        ...
        expect(axiosInstance.post).toHaveBeenCalledWith("projects", expect.any(FormData), {
    ...
    it("updateProject calls POST multipart with method override and sets success", async () => {
        ...
        expect(axiosInstance.post).toHaveBeenCalledWith("projects/55", expect.any(FormData), {
            headers: { "Content-Type": "multipart/form-data" },
        });
