  ...
  actions: {
    ...
    async exportExcel(tab) {
      try {
        ...
        link.setAttribute(
          "download",
          `analytics-${tab}-${new Date().toISOString().slice(0, 10)}.xlsx`,
        );
    ...
    async exportPdf(tab) {
      try {
        ...
        link.setAttribute(
          "download",
          `analytics-${tab}-${new Date().toISOString().slice(0, 10)}.pdf`,
        );
        document.body.appendChild(link);
        link.click();
        link.remove();
    ...
    async fetchTurnoverRate() {
      ...
      try {
        const response = await axiosInstance.get(
          "/analytics/workforce/turnover-rate",
          {
            params: this.buildParams(),
          },
        );
    ...
    async fetchAverageTenure() {
      ...
      try {
        const response = await axiosInstance.get(
          "/analytics/workforce/average-tenure",
          {
            params: this.buildParams(),
          },
        );
    ...
    async fetchNewHireTrends() {
      ...
      try {
        const response = await axiosInstance.get(
          "/analytics/workforce/new-hire-trends",
          {
            params: this.buildParams(),
          },
        );
    ...
    async fetchComplianceRate() {
      ...
      try {
        const response = await axiosInstance.get(
          "/analytics/attendance/compliance-rate",
          {
            params: this.buildParams(),
          },
        );
    ...
    async fetchRemoteOfficeRatio() {
      ...
      try {
        const response = await axiosInstance.get(
          "/analytics/attendance/remote-office-ratio",
          {
            params: this.buildParams(),
          },
        );
    ...
    async fetchLeaveUtilization() {
      ...
      try {
        const response = await axiosInstance.get(
          "/analytics/leave/utilization-rate",
          {
            params: this.buildParams(),
          },
        );
    ...
    async fetchLeaveBalanceTrends() {
      ...
      try {
        const response = await axiosInstance.get(
          "/analytics/leave/balance-trends",
          {
            params: this.buildParams(),
          },
        );
    ...
    async fetchSalaryDistribution() {
      ...
      try {
        const response = await axiosInstance.get(
          "/analytics/payroll/salary-distribution",
          {
            params: this.buildParams(),
          },
        );
    ...
    async fetchDeductionAnalysis() {
      ...
      try {
        const response = await axiosInstance.get(
          "/analytics/payroll/deduction-analysis",
          {
            params: this.buildParams(),
          },
        );
    ...
    async fetchTimelineAdherence() {
      ...
      try {
        const response = await axiosInstance.get(
          "/analytics/projects/timeline-adherence",
          {
            params: this.buildParams(),
          },
        );
    ...
    async fetchTaskVelocity() {
      ...
      try {
        const response = await axiosInstance.get(
          "/analytics/projects/task-velocity",
          {
            params: this.buildParams(),
          },
        );
    ...
    async fetchOverdueTrends() {
      ...
      try {
        const response = await axiosInstance.get(
          "/analytics/projects/overdue-trends",
          {
            params: this.buildParams(),
          },
        );
