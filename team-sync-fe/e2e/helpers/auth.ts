...
export const roleCredentials = {
  manager: { email: "yudhis@teamsync.com", password: "teamsync" },
  hr: { email: "tasyia@teamsync.com", password: "teamsync" },
  finance: { email: "dwimeta@teamsync.com", password: "teamsync" },
  employee: { email: "agung@teamsync.com", password: "teamsync" },
} as const;
